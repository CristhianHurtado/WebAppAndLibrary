<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="WebAppCristhianHurtado_FinalRAD.Login" %>
...
<body>
    <form id="form1" runat="server" class="frmalg">
        ...
        <div class="container">
            ...
            <asp:Button runat="server" ID="btn_cancel" Text="Register" class="cnbtn" OnClick="btn_cancel_Click" />
        </div>
    </form>
</body>
</html>
