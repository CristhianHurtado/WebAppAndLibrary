<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="WebAppCristhianHurtado_FinalRAD.Register" %>
...
<body>
    <form id="form1" runat="server" class="frmalg">
        ...
        <div class="container">
            ...
            <asp:TextBox runat="server" ID="txt_confirm" TextMode="Password" placeholder="Confirm Password"></asp:TextBox>
